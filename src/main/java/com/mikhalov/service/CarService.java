...
public class CarService {
    ...
    public List<Car> carsFromXml(String filePathInResources) {
        List<String> strings = splitXmlByCar(filePathInResources);
        List<Map<String, Object>> maps = new ArrayList<>();
        strings.forEach(str -> maps.add(xmlToMap(str)));
        return toListOfCars(maps);
    }

    public List<Car> carsFromJson(String filePathInResources) {
        List<String> strings = splitJsonByCar(filePathInResources);
        List<Map<String, Object>> maps = new ArrayList<>();
